# Generated by Django 3.2.12 on 2023-08-08 18:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('test_status', models.CharField(choices=[('not_selected', 'Not Selected'), ('taken', 'Test Taken'), ('not_taken', 'Not taken')], max_length=100)),
                ...
                ('unique_application_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='app_no', to='hr.applied_resume')),
            ],
            options={
                'abstract': False,
            },
